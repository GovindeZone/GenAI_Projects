...
st.caption("Budget vs Actual | Variance Analysis | Cashflow | Headcount")
...
if uploaded_file:
    ...
    c5.metric("Budget Variance", format_currency(budget_variance), format_percent(budget_variance_pct))
